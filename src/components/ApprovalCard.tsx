...
export function ApprovalCard({
  ...
  return (
    ...
    >
      ...
      {(card.approvalKind === "openrouter-local-vm" || card.approvalKind === "openrouter-local-vm-session") && (
        <div className="mt-2 flex flex-wrap gap-x-3 gap-y-1 text-[11.5px] text-ink-secondary">
          ...
          {card.approvalKind === "openrouter-local-vm-session" && <span>This task only</span>}
