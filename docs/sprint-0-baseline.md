...
> Historical snapshot from August 30, 2026. Counts, gaps and next steps below
> describe that checkpoint. Jinx, general actions and attachments were added
> later. Use the [current handoff](plans/current-handoff.md) and
> [architecture](../ARCHITECTURE.md) for the September 7 state.
