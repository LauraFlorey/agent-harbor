...
// inside the VM and Agent Harbor never exposes another inbound port.
...
export function remoteComputerBootstrapCommand(botName) {
    ...
    return [
        ...
        `tmux has-session -t work 2>/dev/null || tmux new-session -d -s work 'echo; echo "  ▦ ${safeName}'"'"'s computer — Agent Harbor"; echo; exec bash -i'`,
        "echo bootstrapped",
    ].join("\n");
}
